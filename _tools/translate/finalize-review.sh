...
# (_tools/translate/finalize-review.sh -> ../.. == repo root); VASIC_ROOT overrides.
...
if tf and not os.path.isfile(tf):
    ...
    if m: tf=os.path.join(sys.argv[3], m.group(1))
