...
- **مدیریت ناوگان ناهمگن کارگران.** شبکه‌ای از ماشین‌های Linux، macOS، ویندوز، Aurora و SymphonyOS هدفی متحرک از نظر دسترسی و راه‌اندازی است. ما این مشکل را با یک سرویس اختصاصی استخر کارگران حل کردیم که ثبت مبتنی بر SSH، نصب خودکار روی گره‌های جدید و نظارت مداوم بر سلامت را انجام می‌دهد تا ناوگان با آمدن و رفتن ماشین‌ها همچنان شناخته‌شده و قابل کنترل باقی بماند.
