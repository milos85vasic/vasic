...
- **क्रॉस-प्लेटफ़ॉर्म समानता (केवल Linux के लिए मॉक नहीं)।** एक साझा इंटरफ़ेस से हल किया गया, जिसे बिल्ड टैग्स के माध्यम से वास्तविक प्रति-ओएस सुविधाओं में विभाजित किया गया — Linux cgroup / `/proc` / कर्नेल WireGuard, macOS `sysctl` / `vm_stat` / IOKit / `wireguard-go` — और फिर एक स्वतंत्र ओएस ऑरेकल के विरुद्ध क्रॉस-चेक किया गया, ताकि हर प्लेटफ़ॉर्म वास्तविक नेटिव स्थिति रिपोर्ट करे, न कि Linux की काल्पनिक धारणा।
