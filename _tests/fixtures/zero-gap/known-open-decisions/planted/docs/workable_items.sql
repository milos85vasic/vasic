...
INSERT INTO items VALUES ('DEM-001','Operator-blocked','A blocked item without detail row','No detail row exists for this blocked item at all');
...
INSERT INTO items VALUES ('DEM-004','Operator-blocked','A blocked item with thin detail','Detail row states a condition but no options and no cost');
...
INSERT INTO operator_block_details VALUES ('DEM-004','need a path','tried defaults','the operator names a path','operator');
