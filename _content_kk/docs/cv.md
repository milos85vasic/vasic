...
- **Деректер:** PostgreSQL, SQLite, SQLCipher (тыныштық күйіндегі шифрлау), Redis, Neo4j, ClickHouse, объектілік сақтау (MinIO/S3/GCS/Azure).
...
- **HelixTrack** — еркін әлемдегі JIRA + Confluence баламасы (Helix-Track желісінің флагманы): Go микросервистері, бірыңғай әрекеттік маршруттау API, HTTP/3 арқылы, дерек
